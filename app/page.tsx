...
import CardMediaDev from "@/components/card-media-dev";
import FetcherPopular from "@/components/fetcher-popular";
...
export default async function Home() {  
  return (
      popular !== null ?    
      <header className="relative w-[90%] h-[90%] rounded-[20px] overflow-hidden shadow-[0_10px_25px_8px_rgba(0,0,0,0.25)]
          ...
          {/* <CardMedia /> */}
          {/* <Scroller /> */}
          <FetcherPopular />     {/* // server komponent som hämtar data */}
      </header>
      :
      <header
          className="relative
          ...
          before:w-[100%]
          before:h-[100%]        
          before:bg-[url(@/public/bg-error.jpg)]
          before:bg-center
          before:bg-no-repeat
          before:bg-cover
          before:opacity-[.6]
